 ...
 * Dobiti zustatku.
 */
public class RechargeLltpEvent extends AbstractLltpEvent<ExampleLltpEventDispatcher> {
	...
	public RechargeLltpEvent() {
		super();
	}

	public RechargeLltpEvent(long correlationId, long cln, long amount) {
	...
	public LltpEventResponse<ExampleLltpEventDispatcher> process(ExampleLltpEventDispatcher dispatcher) {
		return dispatcher.recharge(this);
	}
